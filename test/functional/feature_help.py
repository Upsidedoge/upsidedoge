...
"""Verify that starting upsidedoge with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start upsidedoge with -h for help text")
        ...
        self.log.info("Start upsidedoge with -version for version information")
        ...
        self.log.info("Start upsidedoged with -fakearg to make sure it does not start")
