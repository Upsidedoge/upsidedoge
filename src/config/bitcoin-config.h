...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The UpsideDoge Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "UpsideDoge Core"
...
#define PACKAGE_BUGREPORT "https://github.com/upsidedoge-project/upsidedoge/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "UpsideDoge Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "UpsideDoge Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "upsidedoge"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://upsidedoge.org/"
