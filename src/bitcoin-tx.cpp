...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " upsidedoge-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  upsidedoge-tx [options] <hex-tx> [commands]  Update hex-encoded upsidedoge transaction\n" +
            "or:     upsidedoge-tx [options] -create [commands]   Create hex-encoded upsidedoge transaction\n" +
            "\n";
