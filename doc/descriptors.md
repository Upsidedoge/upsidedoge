# Support for Output Descriptors in UpsideDoge Core

Since UpsideDoge Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `updog1...` for mainnet or `tupdog1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on UpsideDoge's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing UpsideDoge Core wallets, a convenience function `combo` is
