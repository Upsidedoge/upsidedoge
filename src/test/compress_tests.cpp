...
// amounts 50 .. 21000000
#define NUM_MULTIPLES_50BTC 1148784.193715
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(      6969*COIN,      0x32));
    BOOST_CHECK(TestPair(8005877046*COIN, 0x501BD00));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_50BTC; i++)
        BOOST_CHECK(TestEncode(i * 6969 * COIN));
