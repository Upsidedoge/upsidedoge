...
bech32_templates = [
  ...
  ('updog',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('updog',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('updog',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tupdog',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tupdog',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tupdog',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rupdog',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rupdog',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rupdog', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tupdog',  17, 32, False, False, False),
  ('rupdog',  3,  1, False, False, False),
  ('updog',   15, 41, False, False, False),
  ('tupdog',  0, 16, False, False, False),
  ('rupdog',  0, 32, True,  False, False),
  ('updog',   0, 16, True,  False, False),
  ('tupdog',  0, 32, False, True,  False),
  ('rupdog',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['updog', 'tupdog', 'rupdog']:
